...
// Helper to mask ID for logging
const maskId = (id: string) => id && id.length > 4 ? `***${id.slice(-4)}` : id;
              ...
              <>
                ...
                {(order.paymentStatus === 'Unpaid' || order.paymentStatus === 'Failed') && (
                  ...
                  >
                    ...
                    <button
                      onClick={() => {
                        log('ui', 'Navigate to payment clicked', { orderId: maskId(orderId) }, { feature: 'orders' });
                ...
                <RequestBillButton 
                  ...
                  onRequested={() => {
                    log('ui', 'Bill requested', { orderId: maskId(orderId) }, { feature: 'orders' });
                  }}
                />
