          ...
          {([
            ...
            <button
              ...
              className={`px-4 py-3 relative text-sm font-semibold transition-colors ${
                activeTab === id ? 'text-emerald-600' : 'text-gray-600 hover:text-gray-900'
              }`}
            >
              {label}
              {activeTab === id && <span className="absolute left-0 right-0 -bottom-px h-0.5 bg-emerald-600" />}
            </button>
          ))}
        </div>
      </div>
        ...
        <Card className="p-6">
          <div className="flex flex-col gap-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="text-gray-900 font-semibold">Restaurant Profile</h3>
                <p className="text-gray-600 text-sm">Public information shown to guests</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-sm font-semibold text-gray-900">Timezone</label>
                <select
                  value={timezone}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className={`p-4 rounded-xl border ${coverUploaded ? 'border-emerald-300 bg-emerald-50' : 'border-dashed border-gray-300'}`}>
        ...
        <Card className="p-6">
          <div className="flex flex-col gap-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="text-gray-900 font-semibold">Opening Hours</h3>
                <p className="text-gray-600 text-sm">Configure daily schedules</p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3 p-4 border border-gray-200 rounded-xl bg-gray-50">
              <div className="flex flex-wrap items-center gap-3">
                ...
                <span className="text-sm text-gray-700">Copy hours from</span>
                <select
                  value={sourceDay}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {days.map((day) => {
                ...
                return (
                  <div key={day} className="p-4 border border-gray-200 rounded-xl flex flex-col gap-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-semibold text-gray-900">{dayLabels[day]}</span>
        ...
        <Card className="p-6">
          <div className="flex flex-col gap-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="text-gray-900 font-semibold">Payments</h3>
                <p className="text-gray-600 text-sm">Enable payment methods for guests</p>
              </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <label className="flex items-center gap-3 p-4 border border-gray-200 rounded-xl text-sm text-gray-800">
                <input type="checkbox" className="rounded border-gray-300 text-emerald-600" checked={stripeEnabled} onChange={(e) => setStripeEnabled(e.target.checked)} />
                Stripe (card)
              </label>
              <label className="flex items-center gap-3 p-4 border border-gray-200 rounded-xl text-sm text-gray-800">
                <input type="checkbox" className="rounded border-gray-300 text-emerald-600" checked={paypalEnabled} onChange={(e) => setPaypalEnabled(e.target.checked)} />
                PayPal
              </label>
              <label className="flex items-center gap-3 p-4 border border-gray-200 rounded-xl text-sm text-gray-800">
                <input type="checkbox" className="rounded border-gray-300 text-emerald-600" checked={cashEnabled} onChange={(e) => setCashEnabled(e.target.checked)} />
                Cash
              </label>
            </div>
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Control which alerts you receive</p>
              </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <label className="flex items-center gap-3 p-4 border border-gray-200 rounded-xl text-sm text-gray-800">
                <input type="checkbox" className="rounded border-gray-300 text-emerald-600" checked={emailNotifications} onChange={(e) => setEmailNotifications(e.target.checked)} />
                Email notifications
              </label>
              <label className="flex items-center gap-3 p-4 border border-gray-200 rounded-xl text-sm text-gray-800">
                <input type="checkbox" className="rounded border-gray-300 text-emerald-600" checked={orderNotifications} onChange={(e) => setOrderNotifications(e.target.checked)} />
                Order updates
              </label>
              <label className="flex items-center gap-3 p-4 border border-gray-200 rounded-xl text-sm text-gray-800">
                <input type="checkbox" className="rounded border-gray-300 text-emerald-600" checked={lowStockAlerts} onChange={(e) => setLowStockAlerts(e.target.checked)} />
                Low stock alerts
              </label>
              <label className="flex items-center gap-3 p-4 border border-gray-200 rounded-xl text-sm text-gray-800">
                <input type="checkbox" className="rounded border-gray-300 text-emerald-600" checked={staffNotifications} onChange={(e) => setStaffNotifications(e.target.checked)} />
                Staff notifications
              </label>
            </div>
        ...
        <Card className="p-6">
          <div className="flex flex-col gap-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="text-gray-900 font-semibold">Security</h3>
                <p className="text-gray-600 text-sm">Control session and 2FA settings</p>
              </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex flex-col gap-2">
                <label className="text-sm font-semibold text-gray-900">Session timeout (minutes)</label>
                <select
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="p-3 border border-gray-200 rounded-xl flex items-center justify-between">
                  <span className="text-sm text-gray-800">{twoFactorEnabled ? 'Enabled' : 'Disabled'}</span>
