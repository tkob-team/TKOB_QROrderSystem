/**
 * ResetPassword Page - New UI Design
...
import { Eye, EyeOff, Lock, CheckCircle, AlertTriangle, ArrowLeft, Check, X } from 'lucide-react';
          ...
          <CardContent className="p-8">
            <div className="flex flex-col items-center gap-6 text-center">
              ...
              <div className="w-full space-y-3">
                <Button 
                  onClick={() => handleNavigate(ROUTES.forgotPassword)}
                  className="w-full h-12 text-base font-semibold"
                >
                  Request New Link
                </Button>
