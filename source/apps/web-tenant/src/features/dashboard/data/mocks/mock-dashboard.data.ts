/**
 * Dashboard Mock Data
 * Raw constants and arrays for mock adapter
 */
...
export const MOCK_REVENUE_DATA: RevenueChartData = {
  today: [
...
export const MOCK_POPULAR_ITEMS: PopularItemData[] = [
...
export const MOCK_KPI_DATA: Record<TimePeriod, KPIData> = {
  'Today': {
