        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-3xl font-bold text-gray-600">7</p>
            </div>
      ...
      <div className="bg-white rounded-lg shadow">
        ...
        <div className="p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">
            Table management and QR code generation features will be implemented in <code className="bg-gray-100 px-2 py-1 rounded">src/features/tables</code>
          </p>
          <p className="text-sm text-gray-500">
            Features include: Table CRUD, QR code generation, QR code download/print
          </p>
        </div>
      </div>
    </div>
